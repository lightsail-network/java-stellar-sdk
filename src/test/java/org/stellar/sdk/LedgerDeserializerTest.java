...
public class LedgerDeserializerTest extends TestCase {
  ...
  public void testDeserialize() {
    ...
    assertEquals(ledger.getSequence(), 898826);
    assertEquals(ledger.getTransactionCount(), 1);
    assertEquals(ledger.getOperationCount(), 2);
    ...
    assertEquals(ledger.getBaseFee(), 100);
    assertEquals(ledger.getBaseReserve(), "10.0000000");
    assertEquals(ledger.getMaxTxSetSize(), 50);
