...
public class TransactionDecodeTest {
  ...
  public void testDecodeTxResult() throws IOException {
    ...
    TransactionResultPair transactionResult = TransactionResultPair.fromXdrBase64(txResult);
    assertEquals(
  ...
  public void testDecodeTxMeta() throws IOException {
    ...
    TransactionMeta transactionMeta = TransactionMeta.fromXdrBase64(txMeta);
  ...
  public void testTransactionEnvelopeWithMemo() throws IOException {
    ...
    TransactionEnvelope transactionEnvelope =
        TransactionEnvelope.fromXdrBase64(transactionEnvelopeToDecode);
  ...
  public void testRoundtrip() throws IOException {
    ...
    TransactionEnvelope transactionEnvelope = TransactionEnvelope.fromXdrBase64(txBody);
    String serialized = transactionEnvelope.toXdrBase64();
