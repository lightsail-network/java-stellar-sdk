...
public class TOIDTest {
    ...
    public void testLedgerRangeInclusive() {
        Assert.assertEquals(new TOID.TOIDRange(new TOID(0, 0, 0).toInt64(), new TOID(2, 0, 0).toInt64()), TOID.ledgerRangeInclusive(1, 1));
        Assert.assertEquals(new TOID.TOIDRange(new TOID(0, 0, 0).toInt64(), new TOID(3, 0, 0).toInt64()), TOID.ledgerRangeInclusive(1, 2));
        Assert.assertEquals(new TOID.TOIDRange(new TOID(2, 0, 0).toInt64(), new TOID(3, 0, 0).toInt64()), TOID.ledgerRangeInclusive(2, 2));
        Assert.assertEquals(new TOID.TOIDRange(new TOID(2, 0, 0).toInt64(), new TOID(4, 0, 0).toInt64()), TOID.ledgerRangeInclusive(2, 3));
    }
