...
public class SubmitTransactionResponseTest extends TestCase {
  ...
  public void testDeserializeSuccessResponse() {
    ...
    assertEquals(submitTransactionResponse.getResult().getResult().getResults()[0].getTr().getDiscriminant(), OperationType.MANAGE_SELL_OFFER);
    assertNotNull(submitTransactionResponse.getResult().getResult().getResults()[0].getTr().getManageSellOfferResult());
  }
