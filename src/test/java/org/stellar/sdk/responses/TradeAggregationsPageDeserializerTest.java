...
public class TradeAggregationsPageDeserializerTest extends TestCase {
  ...
  public void testDeserialize() {
    ...
    assertEquals(page.getRecords().get(0).getHighR().getNumerator().longValue(), 123);
    assertEquals(page.getRecords().get(0).getHighR().getDenominator().longValue(), 10000000);
    assertEquals(page.getRecords().get(0).getLow(), "0.0000124");
    assertEquals(page.getRecords().get(0).getLowR().getNumerator().longValue(), 31);
    assertEquals(page.getRecords().get(0).getLowR().getDenominator().longValue(), 2500000);
    assertEquals(page.getRecords().get(0).getOpen(), "0.0000125");
    assertEquals(page.getRecords().get(0).getOpenR().getNumerator().longValue(), 1);
    assertEquals(page.getRecords().get(0).getOpenR().getDenominator().longValue(), 80000);
    assertEquals(page.getRecords().get(0).getClose(), "0.0000126");
    assertEquals(page.getRecords().get(0).getCloseR().getNumerator().longValue(), 63);
    assertEquals(page.getRecords().get(0).getCloseR().getDenominator().longValue(), 5000000);
  }
