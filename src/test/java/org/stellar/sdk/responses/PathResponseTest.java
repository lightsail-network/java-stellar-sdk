...
public class PathResponseTest {
  ...
  public void testDeserialize() throws IOException {
    ...
    PathResponse pathResponse = GsonSingleton.getInstance().fromJson(json, PathResponse.class);
    ...
    assertEquals(
        ...
        pathResponse.getSourceAssetIssuer());
    ...
    assertEquals(
        ...
        pathResponse.getDestinationAssetIssuer());
    assertEquals("5.0000000", pathResponse.getDestinationAmount());
    assertEquals(
        new AssetTypeCreditAlphaNum4(
            "BB1", "GD5J6HLF5666X4AZLTFTXLY46J5SW7EXRKBLEYPJP33S33MXZGV6CWFN"),
