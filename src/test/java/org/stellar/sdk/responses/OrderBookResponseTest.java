...
public class OrderBookResponseTest {
  ...
  public void testDeserialize() throws IOException {
    ...
    assertEquals(17321279L, orderBookResponse.getBids().get(0).getPriceR().getNumerator().longValue());
    assertEquals(207661034L, orderBookResponse.getBids().get(0).getPriceR().getDenominator().longValue());
    ...
    assertEquals(859L, orderBookResponse.getBids().get(19).getPriceR().getDenominator().longValue());
    ...
    assertEquals(46667L, orderBookResponse.getAsks().get(0).getPriceR().getDenominator().longValue());
    ...
    assertEquals(423729L, orderBookResponse.getAsks().get(19).getPriceR().getNumerator().longValue());
    assertEquals(5000000L, orderBookResponse.getAsks().get(19).getPriceR().getDenominator().longValue());
  }
}
