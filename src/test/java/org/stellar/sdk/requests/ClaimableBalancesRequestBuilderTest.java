...
public class ClaimableBalancesRequestBuilderTest {
  ...
  public void testForSponsor() {
    ...
    HttpUrl uri = server.claimableBalances()
        .forSponsor("GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H")
        .limit(200)
        .order(RequestBuilder.Order.DESC)
        .buildUri();
    assertEquals("https://horizon-testnet.stellar.org/claimable_balances?sponsor=GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H&limit=200&order=desc", uri.toString());
  }
  ...
  public void testForClaimant() {
    Server server = new Server("https://horizon-testnet.stellar.org");
    HttpUrl uri = server.claimableBalances().forClaimant("GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H").buildUri();
    assertEquals("https://horizon-testnet.stellar.org/claimable_balances?claimant=GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H", uri.toString());
  }
  ...
  public void testForNativeAsset() {
    ...
    assertEquals("https://horizon-testnet.stellar.org/claimable_balances?asset=native", uri.toString());
  }

  @Test
  public void testForAsset() {
    Server server = new Server("https://horizon-testnet.stellar.org");
    HttpUrl uri = server.claimableBalances().forAsset(Asset.create("USD:GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H")).buildUri();
    assertEquals("https://horizon-testnet.stellar.org/claimable_balances?asset=USD%3AGBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H", uri.toString());
  }

  @Test
  public void testForAssetAndClaimant() {
    Server server = new Server("https://horizon-testnet.stellar.org");
    HttpUrl uri = server.claimableBalances().forClaimant("GCNY5OXYSY4FKHOPT2SPOQZAOEIGXB5LBYW3HVU3OWSTQITS65M5RCNY").forAsset(Asset.create("USD:GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H")).buildUri();
    assertEquals("https://horizon-testnet.stellar.org/claimable_balances?claimant=GCNY5OXYSY4FKHOPT2SPOQZAOEIGXB5LBYW3HVU3OWSTQITS65M5RCNY&asset=USD%3AGBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H", uri.toString());
  }
