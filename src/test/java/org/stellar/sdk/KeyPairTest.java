...
public class KeyPairTest {
  ...
  public void testSign() {
    ...
    assertArrayEquals(Util.hexToBytes(expectedSig), sig);
  }
  ...
  public void testVerifyTrue() throws Exception {
    ...
    String data = "hello world";
    KeyPair keypair = KeyPair.fromSecretSeed(Util.hexToBytes(SEED));
    assertTrue(keypair.verify(data.getBytes(), Util.hexToBytes(sig)));
  }
  ...
  public void testVerifyFalse() throws Exception {
    ...
    String data = "hello world";
    KeyPair keypair = KeyPair.fromSecretSeed(Util.hexToBytes(SEED));
    assertFalse(keypair.verify(data.getBytes(), Util.hexToBytes(badSig)));
    assertFalse(keypair.verify(data.getBytes(), corrupt));
  }
