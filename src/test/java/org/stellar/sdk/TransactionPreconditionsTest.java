...
public class TransactionPreconditionsTest {
    ...
    public void itConvertsFromXdr() throws IOException {
        ...
        xdr = Preconditions.decode(new XdrDataInputStream(new ByteArrayInputStream(baos.toByteArray())));
    ...
    public void itRoundTripsFromV2ToV1IfOnlyTimeboundsPresent() throws IOException {
        ...
        // marshal the pojo with just timebounds back to xdr, since only timebounds, precond type should be optimized to V!(PRECOND_TIME)
    ...
    public void itConvertsToV2Xdr() throws IOException {
        ...
        SignerKey signerKey = new SignerKey.Builder()
                ...
                .ed25519SignedPayload(new SignerKey.SignerKeyEd25519SignedPayload.Builder()
                        .payload(payload)
                        .ed25519(new Uint256(StrKey.decodeStellarAccountId("GDW6AUTBXTOC7FIKUO5BOO3OGLK4SF7ZPOBLMQHMZDI45J2Z6VXRB5NR")))
                        .build())
                .build();
