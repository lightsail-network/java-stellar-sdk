...
public class TrustLineAsset implements XdrElement {
  ...
  Object toJsonObject() {
    ...
    if (discriminant == AssetType.ASSET_TYPE_POOL_SHARE) {
      LinkedHashMap<String, Object> jsonMap = new LinkedHashMap<>();
      jsonMap.put("pool_share", liquidityPoolID.toJsonObject());
      return jsonMap;
    }
  ...
  static TrustLineAsset fromJsonObject(Object json) {
    if (json instanceof String) {
      String strVal = (String) json;
      if (!(strVal.equals("native"))) {
        throw new IllegalArgumentException("Unexpected string '" + strVal + "' for TrustLineAsset");
      }
      TrustLineAsset instance = new TrustLineAsset();
    ...
    if (jsonMap.size() != 1) {
      throw new IllegalArgumentException(
          "Expected a single-key object for TrustLineAsset, got: " + json);
    }
    ...
    if (key.equals("pool_share")) {
      TrustLineAsset instance = new TrustLineAsset();
      instance.discriminant = discriminant;
      instance.liquidityPoolID = PoolID.fromJsonObject(jsonMap.get("pool_share"));
      return instance;
    }
    throw new IllegalArgumentException("Unknown key '" + key + "' for TrustLineAsset");
  }
}
