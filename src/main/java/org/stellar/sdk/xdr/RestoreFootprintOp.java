...
public class RestoreFootprintOp implements XdrElement {
  ...
  public static RestoreFootprintOp fromJson(String json) {
  ...
  static RestoreFootprintOp fromJsonObject(Object json) {
    java.util.Map<String, Object> jsonMap = (java.util.Map<String, Object>) json;
    RestoreFootprintOp instance = new RestoreFootprintOp();
