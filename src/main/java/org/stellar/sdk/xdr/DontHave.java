...
public class DontHave implements XdrElement {
  ...
  public static DontHave fromJson(String json) {
  ...
  Object toJsonObject() {
    ...
    jsonMap.put("req_hash", reqHash.toJsonObject());
    return jsonMap;
  }

  @SuppressWarnings("unchecked")
  static DontHave fromJsonObject(Object json) {
    java.util.Map<String, Object> jsonMap = (java.util.Map<String, Object>) json;
    DontHave instance = new DontHave();
    instance.type = MessageType.fromJsonObject(jsonMap.get("type"));
    instance.reqHash = Uint256.fromJsonObject(jsonMap.get("req_hash"));
    return instance;
  }
}
