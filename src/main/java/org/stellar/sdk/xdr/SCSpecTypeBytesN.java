...
public class SCSpecTypeBytesN implements XdrElement {
  ...
  public static SCSpecTypeBytesN fromJson(String json) {
  ...
  static SCSpecTypeBytesN fromJsonObject(Object json) {
    java.util.Map<String, Object> jsonMap = (java.util.Map<String, Object>) json;
    SCSpecTypeBytesN instance = new SCSpecTypeBytesN();
    instance.n = Uint32.fromJsonObject(jsonMap.get("n"));
    return instance;
  }
}
