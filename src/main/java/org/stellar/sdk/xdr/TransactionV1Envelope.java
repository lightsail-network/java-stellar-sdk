...
public class TransactionV1Envelope implements XdrElement {
  ...
  public static TransactionV1Envelope fromJson(String json) {
  ...
  static TransactionV1Envelope fromJsonObject(Object json) {
    java.util.Map<String, Object> jsonMap = (java.util.Map<String, Object>) json;
    TransactionV1Envelope instance = new TransactionV1Envelope();
