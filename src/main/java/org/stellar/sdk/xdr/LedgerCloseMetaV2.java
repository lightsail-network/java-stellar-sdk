...
public class LedgerCloseMetaV2 implements XdrElement {
  ...
  public static LedgerCloseMetaV2 fromJson(String json) {
  ...
  static LedgerCloseMetaV2 fromJsonObject(Object json) {
    java.util.Map<String, Object> jsonMap = (java.util.Map<String, Object>) json;
    LedgerCloseMetaV2 instance = new LedgerCloseMetaV2();
    ...
    instance.txProcessing =
        XdrElement.jsonArrayToArray(
            ...
            TransactionResultMetaV1.class,
            item -> TransactionResultMetaV1.fromJsonObject(item));
