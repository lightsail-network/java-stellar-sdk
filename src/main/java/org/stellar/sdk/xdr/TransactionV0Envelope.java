...
public class TransactionV0Envelope implements XdrElement {
  ...
  public static TransactionV0Envelope fromJson(String json) {
  ...
  static TransactionV0Envelope fromJsonObject(Object json) {
    java.util.Map<String, Object> jsonMap = (java.util.Map<String, Object>) json;
    TransactionV0Envelope instance = new TransactionV0Envelope();
    instance.tx = TransactionV0.fromJsonObject(jsonMap.get("tx"));
    instance.signatures =
