...
public class SCPNomination implements XdrElement {
  ...
  public static SCPNomination fromJson(String json) {
  ...
  Object toJsonObject() {
    ...
    jsonMap.put("votes", XdrElement.arrayToJsonArray(votes, i -> votes[i].toJsonObject()));
    jsonMap.put("accepted", XdrElement.arrayToJsonArray(accepted, i -> accepted[i].toJsonObject()));
    return jsonMap;
  }

  @SuppressWarnings("unchecked")
  static SCPNomination fromJsonObject(Object json) {
    java.util.Map<String, Object> jsonMap = (java.util.Map<String, Object>) json;
    SCPNomination instance = new SCPNomination();
    instance.quorumSetHash = Hash.fromJsonObject(jsonMap.get("quorum_set_hash"));
    instance.votes =
        XdrElement.jsonArrayToArray(
            (List<Object>) jsonMap.get("votes"), Value.class, item -> Value.fromJsonObject(item));
    instance.accepted =
        XdrElement.jsonArrayToArray(
            (List<Object>) jsonMap.get("accepted"),
            Value.class,
            item -> Value.fromJsonObject(item));
    return instance;
  }
}
