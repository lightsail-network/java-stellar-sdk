...
public class TransactionResultSet implements XdrElement {
  ...
  public static TransactionResultSet fromJson(String json) {
    return fromJsonObject(XdrElement.gson.fromJson(json, Object.class));
  }

  Object toJsonObject() {
    LinkedHashMap<String, Object> jsonMap = new LinkedHashMap<>();
    jsonMap.put("results", XdrElement.arrayToJsonArray(results, i -> results[i].toJsonObject()));
    return jsonMap;
  }

  @SuppressWarnings("unchecked")
  static TransactionResultSet fromJsonObject(Object json) {
    java.util.Map<String, Object> jsonMap = (java.util.Map<String, Object>) json;
    TransactionResultSet instance = new TransactionResultSet();
    instance.results =
        XdrElement.jsonArrayToArray(
            (List<Object>) jsonMap.get("results"),
            TransactionResultPair.class,
            item -> TransactionResultPair.fromJsonObject(item));
    return instance;
  }
}
