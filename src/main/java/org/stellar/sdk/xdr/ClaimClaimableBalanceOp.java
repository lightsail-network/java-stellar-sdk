...
public class ClaimClaimableBalanceOp implements XdrElement {
  ...
  public static ClaimClaimableBalanceOp fromJson(String json) {
  ...
  static ClaimClaimableBalanceOp fromJsonObject(Object json) {
    java.util.Map<String, Object> jsonMap = (java.util.Map<String, Object>) json;
    ClaimClaimableBalanceOp instance = new ClaimClaimableBalanceOp();
