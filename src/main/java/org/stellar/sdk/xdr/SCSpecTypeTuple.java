...
public class SCSpecTypeTuple implements XdrElement {
  ...
  public static SCSpecTypeTuple fromJson(String json) {
  ...
  Object toJsonObject() {
    ...
    jsonMap.put(
        "value_types", XdrElement.arrayToJsonArray(valueTypes, i -> valueTypes[i].toJsonObject()));
    return jsonMap;
  }

  @SuppressWarnings("unchecked")
  static SCSpecTypeTuple fromJsonObject(Object json) {
    java.util.Map<String, Object> jsonMap = (java.util.Map<String, Object>) json;
    SCSpecTypeTuple instance = new SCSpecTypeTuple();
    instance.valueTypes =
        XdrElement.jsonArrayToArray(
            (List<Object>) jsonMap.get("value_types"),
            SCSpecTypeDef.class,
