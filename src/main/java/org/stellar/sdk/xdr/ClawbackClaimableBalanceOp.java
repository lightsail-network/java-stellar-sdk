...
public class ClawbackClaimableBalanceOp implements XdrElement {
  ...
  public static ClawbackClaimableBalanceOp fromJson(String json) {
  ...
  static ClawbackClaimableBalanceOp fromJsonObject(Object json) {
    java.util.Map<String, Object> jsonMap = (java.util.Map<String, Object>) json;
    ClawbackClaimableBalanceOp instance = new ClawbackClaimableBalanceOp();
