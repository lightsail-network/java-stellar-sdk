...
public class FeeBumpTransactionEnvelope implements XdrElement {
  ...
  public static FeeBumpTransactionEnvelope fromJson(String json) {
  ...
  Object toJsonObject() {
    ...
    jsonMap.put(
        "signatures", XdrElement.arrayToJsonArray(signatures, i -> signatures[i].toJsonObject()));
    return jsonMap;
  }

  @SuppressWarnings("unchecked")
  static FeeBumpTransactionEnvelope fromJsonObject(Object json) {
    java.util.Map<String, Object> jsonMap = (java.util.Map<String, Object>) json;
    FeeBumpTransactionEnvelope instance = new FeeBumpTransactionEnvelope();
    instance.tx = FeeBumpTransaction.fromJsonObject(jsonMap.get("tx"));
    instance.signatures =
        XdrElement.jsonArrayToArray(
            (List<Object>) jsonMap.get("signatures"),
            DecoratedSignature.class,
            item -> DecoratedSignature.fromJsonObject(item));
    return instance;
  }
}
