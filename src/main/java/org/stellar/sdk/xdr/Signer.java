...
public class Signer implements XdrElement {
  ...
  Object toJsonObject() {
    ...
    jsonMap.put("weight", weight.toJsonObject());
    return jsonMap;
  }

  @SuppressWarnings("unchecked")
  static Signer fromJsonObject(Object json) {
    java.util.Map<String, Object> jsonMap = (java.util.Map<String, Object>) json;
    Signer instance = new Signer();
    instance.key = SignerKey.fromJsonObject(jsonMap.get("key"));
    instance.weight = Uint32.fromJsonObject(jsonMap.get("weight"));
    return instance;
  }
}
