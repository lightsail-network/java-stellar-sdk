...
public class CreateContractArgs implements XdrElement {
  ...
  public static CreateContractArgs fromJson(String json) {
  ...
  static CreateContractArgs fromJsonObject(Object json) {
    java.util.Map<String, Object> jsonMap = (java.util.Map<String, Object>) json;
    CreateContractArgs instance = new CreateContractArgs();
