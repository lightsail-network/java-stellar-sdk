...
public class ShortHashSeed implements XdrElement {
  ...
  public static ShortHashSeed fromJson(String json) {
    return fromJsonObject(XdrElement.gson.fromJson(json, Object.class));
  }

  Object toJsonObject() {
    LinkedHashMap<String, Object> jsonMap = new LinkedHashMap<>();
    jsonMap.put("seed", XdrElement.bytesToHex(seed));
    return jsonMap;
  }

  @SuppressWarnings("unchecked")
  static ShortHashSeed fromJsonObject(Object json) {
    java.util.Map<String, Object> jsonMap = (java.util.Map<String, Object>) json;
    ShortHashSeed instance = new ShortHashSeed();
    instance.seed = XdrElement.hexToBytes((String) jsonMap.get("seed"));
    return instance;
  }
}
