...
public class PathPaymentStrictReceiveOp implements XdrElement {
  ...
  /**
   * Value of the {@code sendMax} field.
   *
   * @param sendMax the {@code sendMax} field value
   * @return the {@code sendMax} field value
   */
  ...
  /**
   * Value of the {@code destAmount} field.
   *
   * @param destAmount the {@code destAmount} field value
   * @return the {@code destAmount} field value
   */
