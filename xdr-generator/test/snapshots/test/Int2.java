...
public class Int2 implements XdrElement {
  ...
  public static Int2 decode(XdrDataInputStream stream, int maxDepth) throws IOException {
    if (maxDepth <= 0) {
  ...
  public static Int2 fromJson(String json) {
    return fromJsonObject(XdrElement.gson.fromJson(json, Object.class));
  }
  Object toJsonObject() {
    return int2.toString();
  }
  static Int2 fromJsonObject(Object json) {
    Int2 instance = new Int2();
    instance.int2 = XdrElement.jsonToLong(json);
    return instance;
  }
}
